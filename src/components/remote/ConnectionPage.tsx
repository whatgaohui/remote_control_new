          ...
          <Card className="border-slate-800 bg-gradient-to-r from-slate-900/80 to-slate-900/60 backdrop-blur-sm">
            <CardHeader className="pb-0">
              <CardTitle className="flex items-center gap-2 text-lg text-white">
                ...
                <Badge variant="outline" className="border-cyan-500/30 bg-cyan-500/10 text-cyan-400 text-[10px]">v2.0.0 最新版</Badge>
              </CardTitle>
              <CardDescription className="text-slate-400">
                下载带界面的桌面版程序，无需命令行操作
              </CardDescription>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="group rounded-xl border border-slate-700/50 bg-slate-800/40 p-4 transition-all hover:border-emerald-500/30 hover:bg-slate-800/60">
                  <div className="mb-3 flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-white">RC-Server 服务端 <span className="text-emerald-400 text-[11px] font-normal">v2.0.0</span></h3>
                  ...
                  >
                    <a href="/downloads/RC-Server-GUI-v2.0.0.zip" download>
                ...
                <div className="group rounded-xl border border-slate-700/50 bg-slate-800/40 p-4 transition-all hover:border-cyan-500/30 hover:bg-slate-800/60">
                  <div className="mb-3 flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-white">RC-Client 客户端 <span className="text-cyan-400 text-[11px] font-normal">v2.0.0</span></h3>
                      <p className="text-xs text-slate-500">带界面的 Windows 桌面版 · ~94MB</p>
                    </div>
                  </div>
                  <p className="mb-3 text-xs text-slate-400 leading-relaxed">
                  ...
                  >
                    <a href="/downloads/RC-Client-GUI-v2.0.0.zip" download>
                      <Download className="mr-1.5 h-4 w-4" />
                      下载 RC-Client v2.0.0
                    </a>
                  </Button>
              ...
              <div className="mt-4 rounded-lg border border-slate-700/30 bg-slate-900/40 p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-slate-400 leading-relaxed">
                    ...
                    <p>1. 下载并解压 <code className="rounded bg-slate-800 px-1 py-0.5 text-emerald-400">RC-Server-GUI-v2.0.0.zip</code>，双击运行 <code className="rounded bg-slate-800 px-1 py-0.5 text-emerald-400">RC-Server.exe</code></p>
                    <p>2. 在服务端界面点击 <code className="rounded bg-slate-800 px-1 py-0.5 text-emerald-400">启动服务</code> 按钮，默认监听 9527 端口</p>
                    <p>3. 下载并解压 <code className="rounded bg-slate-800 px-1 py-0.5 text-cyan-400">RC-Client-GUI-v2.0.0.zip</code>，双击运行 <code className="rounded bg-slate-800 px-1 py-0.5 text-cyan-400">RC-Client.exe</code></p>
